...
public class FileSystem {
	...
	public static void main(String[] args){
	    ...
	    System.out.println("Date created: "+rootDirectory.created);
	    //Now printing the sub directories 
	    System.out.println();
	    System.out.println("****************SUB DIRECTORY DETAILS***************** ");
	    System.out.println("sub directory: "+Gaurav.getName()+ ", Owner is: "+rootDirectory.getOwner()+ ", size is "+Gaurav.getSize()+ "Date Created: "+Gaurav.created);
	    System.out.println("sub directory: "+Ajay.getName()+ ", Owner is: "+rootDirectory.getOwner()+ ", size is "+Ajay.getSize()+"Date Created: "+Ajay.created);
	    System.out.println("sub directory: "+Ram.getName()+ ", Owner is: "+rootDirectory.getOwner()+ ", size is "+Ram.getSize()+"Date Creatded: "+Ram.created);
